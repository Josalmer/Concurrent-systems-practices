...
Productor-Consumidor con cola FIFO y monitor SC
*/
...
void funcion_hebra_productora( ProdConsFIFOSC * monitor , int indiceHebra )
{
...
{
   cout << "-------------------------------------------------------------------------------" << endl
        << "Problema de los productores-consumidores Monitor SC, buffer FIFO con " << nproductores << " productores y " << nconsumidores << " consumidores." << endl
        << "-------------------------------------------------------------------------------" << endl
        << flush ;
