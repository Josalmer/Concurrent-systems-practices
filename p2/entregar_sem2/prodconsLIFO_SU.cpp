...
Productor-Consumidor con cola LIFO y monitor con espera urgente
*/
...
// *****************************************************************************
// clase para monitor buffer, version LIFO, semántica SU, nproductores prod. y nconsumidores cons.
...
void funcion_hebra_productora( MRef<ProdConsLIFOSU> monitor , int indiceHebra )
{
...
{
   cout << "-------------------------------------------------------------------------------" << endl
        << "Problema de los productores-consumidores Monitor SU, buffer LIFO con " << nproductores << " productores y " << nconsumidores << " consumidores." << endl
        << "-------------------------------------------------------------------------------" << endl
        << flush ;
